            ...
            if (
                ...
                warning(
                    sprintf(
                        ...
                        Expected %s, got %s. Using default value.",
                        param_name,
                        class(default_params[[param_name]]),
                        class(params[[param_name]])
                    )
                )
                # Optionally use the default value in case of mismatch
